# Написать программу преобразовывающую число в строку, содержащую звуки капель дождя, соответствующие определенным потенциальным факторам, т. е число, должно делится на другое число, не оставляя остатка. 
